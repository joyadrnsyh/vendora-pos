...
export default function AdminDashboard() {
  ...
  const handleLogout = () => {
    localStorage.clear();
    router.push("/dashboard"); // Kembali ke Gateway
  };
        ...
        <div className="space-y-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-bold text-slate-900 tracking-tight">
              Vendora <span className="text-xs bg-red-100 text-red-600 px-2 py-0.5 rounded-full ml-1 align-top">ADMIN</span>
            </span>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8">
          ...
          {activeTab !== "Overview" && activeTab !== "Users" && (
            <div className="bg-white p-12 rounded-2xl border border-slate-100 shadow-sm flex flex-col items-center justify-center text-center">
              ...
              <p className="text-slate-500 text-sm max-w-sm">Fitur ini sedang dalam pengembangan untuk versi Admin Dashboard berikutnya.</p>
            </div>
          )}
